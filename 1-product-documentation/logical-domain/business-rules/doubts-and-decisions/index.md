# Catalog : Product Documentation - Logical Domain - Business Rules - Doubts And Decisions

| File name | Description |
|---|---|
| `README.md` | Scope and operating rules for this folder. |
| `decision-matrix.md` | Decision Id index per BR element owned by this block. |
