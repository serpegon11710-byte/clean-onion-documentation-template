...
Manages questions and decisions for `business-rules/` (logical-domain).
...
This block maintains [decision-matrix.md](decision-matrix.md): Decision Id index by **this block's elements only** (BR IDs).
