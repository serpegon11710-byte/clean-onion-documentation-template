...
This block maintains [decision-matrix.md](decision-matrix.md): effective doubts indexed by **this block's elements only** (BR IDs).
...
| `decision-matrix.md` | Effective doubt per `(element, event)` — links to `solved/` records only |
