# Catalog : Product Documentation - Diagrams C4 - L4 Critical Zones - Doubts And Decisions

| File name | Description |
|---|---|
| `README.md` | Scope and operating rules for this folder. |
| `decision-matrix.md` | Decision Id index per ZC element owned by this block. |
...
| ID | Title | Deferred Date | Deferred Target (optional) |
|---|---|---|---|
