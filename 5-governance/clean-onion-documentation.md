...
- **`index.md` anti-aggregation (Mandatory):** `index.md` is a local catalog only. Persistent cross-scope/global inventories (maps/catalogs/lists that aggregate artifacts from child branches or multiple blocks) are **forbidden** in any `index.md`.
