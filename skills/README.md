...
| `skills/precommit-audit.md` | `.cursor/skills/precommit-audit/SKILL.md` | Full ad-hoc pre-commit audit without commit and without fail-fast |
| `skills/working-tree-validation.md` | `.cursor/skills/working-tree-validation/SKILL.md` | Pre-add working-tree candidate audit before `git add` |
